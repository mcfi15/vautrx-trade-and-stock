            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">{{ number_format($deposit->amount, 8) }}
                            {{ strtoupper($deposit->cryptocurrency->symbol) }}</span>
                    </div>
                    @if($deposit->fee > 0)
                        <div class="flex justify-between">
                            <span class="text-gray-600">Fee:</span>
                            <span class="font-medium">{{ number_format($deposit->fee, 8) }}
                                {{ strtoupper($deposit->cryptocurrency->symbol) }}</span>
                        </div>
                    @endif
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="font-medium">{{ $deposit->confirmations }}/{{ $deposit->required_confirmations }}</span>
                    </div>
                </div>
            </div>
        ...
        @if($deposit->hasPaymentProof())
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.deposits.payment-proof', $deposit) }}" target="_blank"
                        ...
                        <form method="POST" action="{{ route('admin.deposits.payment-proof.delete', $deposit) }}"
                            class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                ...
                <div class="border rounded-lg p-4">
                    <img src="{{ asset($deposit->payment_proof_path) }}" alt="Payment Proof"
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center">
                        <input type="text" value="{{ $deposit->transaction_hash }}" readonly
            ...
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <form method="POST" action="{{ route('admin.deposits.approve', $deposit) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="admin_notes" rows="3" class="w-full px-3 py-2 border rounded-md"
