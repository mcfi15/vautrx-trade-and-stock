...
@section('content')
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-8 mt-3">
                                <h1>Announcement-on-Resumption-of-IOTA-USDT-trading
                                </h1>
                    ...
                    <div class="col-lg-12 card p-20">
                        <div>
                            ...
                            <h1 class="f-s-24 f-w-600 m-b-15">
                                Announcement-on-Resumption-of-IOTA-USDT-trading
                            </h1>
                            <figure>
	...
	<div class="my-blog-post-box">
		<div class="my-blog-post-box">
			...
			<p>
				We will resume IOTA/USDT trading at 06:00 on July 26, 2023 (UTC). Apologies for the inconvenience caused!
				<br>
        <br>
        <br>
        <br>
			...
			<p>
				<font size="3"><strong>Support&nbsp;Team</strong></font>
		</div>
	</div>
</div></p></div>
                </div>
