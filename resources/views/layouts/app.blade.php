...
<head>
    ...
    <title>
        @yield('title', \App\Models\Setting::get('site_name', 'Vautrx') . ' | Secure & Fast Cryptocurrency Exchange for Bitcoin, Ethereum &amp; Altcoins')
    </title>
            ...
            <div class="col-12">
                <div class="footer-blocks">
                    ...
                    <div class="block">
                        ...
                        <ul>
                            <li>
                                <a href="mailto:{{ \App\Models\Setting::get('support_email', 'support@vautrx.com') }}"
                                    style="white-space: nowrap; margin-bottom: 5px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                        <path fill="#fff"
                                            d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" />
                                    </svg>
                                    {{ \App\Models\Setting::get('support_email', 'support@vautrx.com') }} </a>
                            </li>
                            <li>
                                <a href="mailto:{{ \App\Models\Setting::get('info_email', 'info@vautrx.com') }}" style="white-space: nowrap; margin-bottom: 5px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                        <path fill="#fff"
                                            d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" />
                                    </svg>
                                    {{ \App\Models\Setting::get('info_email', 'info@vautrx.com') }} </a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="panel-group pt-3 pb-3" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                <ul class="link-wrapper">
                    <li>
                        <a href="mailto:{{ \App\Models\Setting::get('support_email', 'support@vautrx.com') }}" style="white-space: nowrap; margin-bottom: 5px;">
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                <path fill="#fff"
                                    d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" />
                            </svg>
