  ...
  <div class="market-trade">
    <div class="d-flex justify-content-between align-items-center">
      <ul class="nav nav-pills" role="tablist">
        ...
        <li class="nav-item">
          <span class="nav-link" onclick="switchOrderType('stop')">Stop-Limit</span>
        </li>
      </ul>
        ...
        <div class="outflexboxx d-flex justify-content-between">
          ...
          <div class="market-trade-buy">
            ...
            <div class="input-group">
              <input class="form-control" placeholder="Qty" type="number" id="buy_num" name="num" step="0.00000001" />
              <div class="input-group-append">
                <button style="min-width: 2.5rem" class="btn btn-increment hide-mobile" type="button"
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <p class="m-b-0">Fee: <span id="buy_fees">{{ number_format($tradingPair->trading_fee, 2) }}</span>%
              </p>
            </div>
          ...
          <div class="market-trade-sell">
            ...
            <div class="input-group">
              <input class="form-control" placeholder="Qty" type="number" id="sell_num" name="num" step="0.00000001" />
              <div class="input-group-append">
                <button style="min-width: 2.5rem" class="btn btn-increment hide-mobile" type="button"
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <p class="m-b-0">Fee: <span id="sell_fees">{{ number_format($tradingPair->trading_fee, 2) }}</span>%
              </p>
            </div>
