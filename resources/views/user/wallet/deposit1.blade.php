                ...
                <div class="card p-4 hover-glow">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-accent fw-semibold"
                                data-address="{{ $wallet->address ?? '' }}" onclick="copyAddress(this)">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control bg-transparent">
                                {{ number_format($cryptocurrency->min_deposit_amount ?? 0.001, 8) }}
                    ...
                    <form method="POST" action="{{ url('wallet/deposit/submit', $cryptocurrency->id) }}"
                        enctype="multipart/form-data" class="mt-4">
                        @csrf

                        <div class="mb-3">
                            <label for="amount" class="form-label small text-secondary">Deposit Amount</label>
                            <input type="number" step="0.00000001" min="0" class="form-control" name="amount" id="amount"
                                required>
                        </div>

                        <div class="mb-3">
                            <label for="payment_proof" class="form-label small text-secondary">Upload Payment Proof
                                (optional)</label>
                    ...
                    <div class="alert alert-warning mt-4">
                        <div>
                            ...
                            <ul class="small mb-0 pl-3">
                                ...
                                <li>Minimum deposit: {{ number_format($cryptocurrency->min_deposit_amount ?? 0.001, 8) }}
                                    {{ strtoupper($cryptocurrency->symbol ?? '') }}.</li>
